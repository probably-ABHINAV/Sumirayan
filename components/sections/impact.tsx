    ...
    <section className="py-24 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          {/* Client Logos */}
          <div>
            <h3 className="text-sm uppercase tracking-widest text-muted-foreground mb-6">Trusted By</h3>
            <div className="overflow-hidden relative">
              ...
              >
                {[...Array(12)].map((_, i) => (
                  <div
                    key={i}
                    className="flex-shrink-0 w-32 h-16 rounded-lg bg-muted/50 flex items-center justify-center text-muted-foreground text-sm font-medium"
                  >
                    Logo {(i % 6) + 1}
                  </div>
                ))}
