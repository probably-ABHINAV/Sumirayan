          ...
          <div className="sm:col-span-2 text-center sm:text-left">
            ...
            <div className="flex justify-center sm:justify-start gap-4 flex-wrap">
              {[
                {
                  name: "Instagram",
                  url: "https://www.instagram.com/sumirayan_design?igsh=Y3Y5eWU1OHRkaXI2", // Replace with your link
                ...
                {
                  name: "Facebook",
                  url: "https://www.facebook.com/share/1AgVQMPA3y/", // Replace with your link
